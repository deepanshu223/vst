			...
			<!-- Contact Section -->
         	<div class="page pt-contact" data-simplebar>
            	<section class="container">
					...
					<div class="row mt-100">
            <div class="col-lg-6 col-sm-6">
              <!-- Calendify inline widget begin -->
              <div id="calendify-widget" data-id="50e4f254-3eae-11ea-a731-e7de49453746" style="height:800px"></div>
              <script type="text/javascript" src="https://book.calendify.cloud/js/widget.js">
              </script>
<!-- Calendify inline widget end -->
            </div>
            <div class="col-lg-6 col-sm-6">
              <div class="box-2 contact-info">
                <div class="row">
                  <div class="col-lg-6 col-sm-12 info">
                    ...
                    <span>Email</span>
                        <p>Hello@vasishtachary.com</p>

                  </div>
                  <div class="col-lg-6 col-sm-12 info">
                    <i class="fas fa-map-marker-alt"></i>
                    <span>Location</span>
                        <p>Jabalpur, Delhi and SF</p>
